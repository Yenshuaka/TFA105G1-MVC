            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-10 offset-md-1  text-center">
                        <!-- login-wrapper-start -->
                        <div class="login-wrapper" class="modal-dialog modal-dialog-centered">
                            <ul class="ui-list nav nav-tabs justify-content-center mar-bot-30" role="tablist">                                
                                <li class="nav-item">
                                    <a class="nav-link active" data-toggle="tab" href="#register" role="tab" aria-selected="false">註冊</a>
                                </li>
                            </ul>
                            <div class="ui-dash tab-content">
                                <div class="tab-pane fade show active" id="register" role="tabpanel">
                                    <form id="register-form" action="<%=request.getContextPath()%>/member/member.register" method="post">
                                        ...
                                        <div class="res-box text-left">
                                            <input type="checkbox" tabindex="3" class="" name="agreement" id="agreement" value="agreement"required>
                                            <label for="agreement">我已詳閱並同意 <a href="#TermsAndConditions">使用者條款</a> &amp; <a href="#Privacy">隱私權保護政策</a></label>
                                        </div>
                                        <div class="res-box text-center mar-top-30">
                                            <button type="submit" class="btn v3" value="register"><i class="ion-android-checkmark-circle"></i>註冊</button>
                                        </div>
                                    </form>
                                    <div class="col-md-8 col-12 text-left">
										<div class="res-box sm-left">
													已經有帳號了？<a href="<%=request.getContextPath() %>/download/FS-login.jsp" tabindex="5" class="register"><i class="ion-log-in"></i> 登入</a>
										</div>
									</div>
