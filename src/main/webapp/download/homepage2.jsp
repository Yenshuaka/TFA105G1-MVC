...
<body>
   <!--Preloader starts-->
    ...
    <div class="page-wrapper">
        ...
        <!--Header ends-->
        <!--Hero section starts-->
        <div class="hero v2 section-padding" style="background-image: url(images/taiwan.jpg)">
                        ...
                        <form class="hero__form v2">
                            <div class="row">
                                <div class="col-lg-4 col-md-12">
                                    <input class="hero__form-input custom-select" type="text" name="place-event" id="place-event" placeholder="輸入關鍵字搜尋">
                    ...
                    <div class="col-md-10 offset-md-1">
                        <div class="hero-catagory-menu text-center">
                            ...
                            <ul>
                                ...
                                <li><a href="all-categories.html"><i class="icofont-hotel"></i> 多日遊</a></li>
                                <li><a href="all-categories.html"><i class="ion-android-bus"></i> 包車</a></li>
                                <li><a href="all-categories.html"><i class="icofont-ticket"></i> 熱門票卷</a></li>
                                <li><a href="all-categories.html"><i class="icofont-camping-vest"></i> 獨特體驗</a></li>
                            </ul>
                        </div>
                    </div>
                </div>
