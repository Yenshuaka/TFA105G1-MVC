                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label>文章標題</label>
                                            <input type="text" class="form-control filter-input" placeholder="Hotel Ocean paradise" name="posttitle">
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label>會員編號</label>
                                            <input type="text" class="form-control filter-input" placeholder="Keywords should be separated by commas" name="memberid">
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
...
<!--                                         <form> -->
                                            <div class="form-group">
                                                ...
                                                <textarea class="form-control" id="list_info" rows="4" placeholder="Enter your text here" name="postcontent"></textarea>
                                            </div>
<!--                                         </form> -->
                                    </div>
