...
<%
OrderBean orderbean = (OrderBean) session.getAttribute("orderBean"); //EmpServlet.java(Concroller), 存入req的empVO物件
%>
					...
					<div class="row">
						<div class="col-md-12">
							<div class="recent-activity my-listing">
								<div class="act-title">
									<h5>
										<i class="ion-social-buffer-outline"></i> 訂單資料
									</h5>
								</div>
								...
								<div class="viewd-item-wrap">
									...
									<table>
										...
										<tr>
											...
											<td><%=orderbean.getMemberid()%></td>
											<td><%=orderbean.getOrderdate()%></td>
											<td><%=orderbean.getOrderpriceamount()%></td>
											<td><%=orderbean.getUsedfunpoints()%></td>
										</tr>
									</table>
