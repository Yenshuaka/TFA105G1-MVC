...
<%
OrderBean orderBean = (OrderBean) request.getAttribute("orderBean"); //EmpServlet.java (Concroller) 存入req的empVO物件 (包括幫忙取出的empVO, 也包括輸入資料錯誤時的empVO物件)
%>
								...
								<div class="viewd-item-wrap">
									...
									<FORM METHOD="post" ACTION="order.do" name="form1">
										...
										<td><input class="input_update" type="TEXT"
											name="traveler" size="45" value="<%=orderBean.getMemberid()%>" /></td>
										<br> <br>
										<h12>訂購日期:&nbsp&nbsp&nbsp&nbsp</h12>
										<input class="input_update" name="orderdate" id="f_date1"
											type="text"><br> <br>
										<h13>訂單總金額:</h13>
										<input class="input_update" type="TEXT" name="ordername"
											size="45" value="<%=orderBean.getOrderpriceamount()%>" />
										</td> <br> <br>
										<h12>折抵點數:&nbsp&nbsp&nbsp&nbsp</h12>
										<td><input class="input_update" type="TEXT"
											name="productid" size="45"
											value="<%=orderBean.getUsedfunpoints()%>" /></td> <br> <br>
											...
											<input class="send" type="submit" value="送出修改">
									</FORM>
