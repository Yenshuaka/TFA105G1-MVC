				...
				<div class=div_gin>
					...
					<div class="self_intro">
						...
						<h5>日本京都留學，曾於大阪的汽車業界工作約4年，擔任國外業務並負責拓展歐洲與澳洲市場。我是一個很喜歡與人交流並學習新事物的人，會說中、英、日、西四國語言，
							也時常與國外客人和研發團隊溝通協調，每年開發出多項滿足客人需求的商品。在開發「fun心遊台灣」時，我總是充滿活力與笑容，會主動關心其他組員的近況，並積極參與討論，
							確認專題的方向與進度是否有符合當初制定的目標。軟體程式是一種更充滿挑戰性的語言，期許自己在技術上精益求精，除了寫出效能好的程式之外，也會透過自身的「溝通能力」
							與團隊密切合作貢獻所學，成為一名獨當一面的工程師。</h5>
					</div>
				</div>

				<div class=div_gin>
					<img class="self_photo3" src="images/nick2.jpg" alt="">
					<div class="self_intro">
						<h4>吳明龠 Nick Wu</h4>
