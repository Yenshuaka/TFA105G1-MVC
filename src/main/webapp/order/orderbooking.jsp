<%@page import="com.product.product.model.ProductBean" %>
									...
									<%@ page
										...
										<head>
											...
											<link
												...
												rel="stylesheet">
											<!-- Plugins CSS -->
											<link href="<%=request.getContextPath()%>/order/css_orderbooking/plugin.css"
												rel="stylesheet" />
											<!-- style CSS -->
											<link href="<%=request.getContextPath()%>/order/css_orderbooking/style.css"
												rel="stylesheet" />
											<!--color switcher css-->
											<link rel="stylesheet"
				...
				<form METHOD="post"ACTION="<%=request.getContextPath()%>/order.do">
											<div class="page-wrapper">
												...
												<%@ include file="/download/file/FS_Header.file" %>
													...
													<div class="buyer_board">
															...
															<div class="col-md-4 col-sm-6 col-xs-12">
																<div class="form_group">
																	...
																	<% MemberVO member=(MemberVO)
																		session.getAttribute("member"); List<MemberVO>
																		allMember = (List<MemberVO>)
																			session.getAttribute("allMember");
																			...
																			for (int i = 0; i < allMember.size(); i++) {
																				if
																				(member.getMemberid()==allMember.get(i).getMemberid())
																				{
																				lastname=allMember.get(i).getLastname();
																				} } String firstname=null; for (int i=0;
																				i < allMember.size(); i++) { if
																				(member.getMemberid()==allMember.get(i).getMemberid())
																				{
																				firstname=allMember.get(i).getFirstname();
																				} } String memberid=null; for (int i=0;
																				i < allMember.size(); i++) { if
																				(member.getMemberid()==allMember.get(i).getMemberid())
																				{ memberid=allMember.get(i).getIdno(); }
																				} String phone=null; for (int i=0; i <
																				allMember.size(); i++) { if
																				(member.getMemberid()==allMember.get(i).getMemberid())
																				{ phone=allMember.get(i).getPhone(); } }
																				String email=null; for (int i=0; i <
																				allMember.size(); i++) { if
																				(member.getMemberid()==allMember.get(i).getMemberid())
																...
																<div class="form_group">
																	<label>名字<span class="require_mark">*</span></label>
																	<br> <input type="text" name="memberFirstname"
																		class="form_control" id="book_first_name"
																		value="<%=firstname%>">
																</div>
															</div>
														</div>
														<div class="row">
															<div class="col-md-4 col-sm-6 col-xs-12">
																<div class="form_group">
																	<label>身分證號碼 <span
																			class="require_mark">*</span><br></label>
																	<br> <input type="text" name="memberIdno"
																		class="form_control" id="book_id"
																		value="<%=memberid%>">
																</div>
																<div class="form_group">
																	<label>連絡電話<span
																	...
																	<input value="<%=phone%>" type="text"
																		name="memberPhone" class="form_control"
																		id="contact_phone">
																</div>
															</div>
														</div>
														<div class="row">
															<div class="email_move">
																<label>電子郵件信箱<span
																		class="require_mark">*</span><br></label> <br>
													...
													<% List<ProductBean> productBeans = (List<ProductBean>)
															session.getAttribute("products");
															List<ProductBean> products = (List<ProductBean>)
																	session.getAttribute("allProducts");
																	List<Integer> imgids = (List<Integer>)
																			session.getAttribute("imgids");
																			%>

																			<% for (int i=0; i < productBeans.size();
																				i++) { %>

																				<% String productname=null; for (int
																					j=0; j < products.size(); j++) { if
																					(productBeans.get(i).getProductid()==products.get(j).getProductid())
																					{
																					productname=products.get(j).getProductname();
																					} } %>

																					<% java.sql.Date startdate=null; for
																						(int j=0; j < products.size();
																						j++) { if
																						(productBeans.get(i).getProductid()==products.get(j).getProductid())
																						{
																						...
																						<% java.sql.Date enddate=null;
																							...
																							<div id="traveler_Infor">
																								<div
																									class="sub_title_traveler">
																									旅客資料</div>

																								<div
																									class="traveler_board">
																									<div>
																										<img class="pic"
																									...
																									<div
																										...
																										團員人數</div>
																									<br> <label
																										style="margin-left: 10px">人數</label><span
																										class="require_mark">*</span><br>
																									<select
																										style="margin-left: 10px"
																										name="numberoftraveler"
																										id="numberoftraveler"
																										class="numberoftraveler <%=productname%>">
																										...
																										<div
																											...
																											<div
																												...
																												<button
																													class="btn_ex"
																													type="button"
																													onclick="clear_info(this);">清空</button>
																											</div>
																											<div
																												class="same_person">
																												<select
																											...
																											<div
																												class="form_group">
																												<label
																													style="margin-left: 10px">性別
																													<span
																														class="require_mark">*</span><br></label>
																												<br>
																												<select
																													name="gender"
																													class="traveler_gender"
																													id="traveler_gender">
																													<option
																														selected>
																														請選擇
																											...
																											<div
																												class="form_group">
																												<label
																													style="margin-left: 10px">姓氏<span
																														class="require_mark">*</span><br></label>
																												<br>
																												<input
																													style="margin-left: 10px"
																													type="text"
																													name="lastname"
																													class="traveler_last_name"
																													id="traveler_last_name${i}">
																												<div
																													class="tip_text_danger">
																													此欄位必填
																												</div>
																									...
																									<div
																										class="form_group">
																										<label>行程導覽語言</label><span
																											class="require_mark">*</span><br>
																										<select name=""
																											id="booking_guide_language"
																											class="form_control">
																											<option
																												disabled="disabled"
																												selected>
																												...
																												<div
																													...
																													<div
																														...
																														<div
																															class="form_group2">
																															<label
																																class="gray_text3">信用卡號碼</label><br>
																															<input
																																type="text"
																																class="card_number"
																														...
																														<div
																															class="form_group2">
																															<label
																																class="gray_text3">有效期限</label><br>
																															<input
																																type="text"
																																class="card_number"
																																id="expire_date"
																														...
																														<div
																															class="form_group2">
																															<label
																																class="gray_text3">背面末3碼</label><br>
																															<input
																																type="text"
																																class="card_number"
																																id="back_number"
																										...
																										<ul
																											...
																											<li><a class="link_title1"
																												...
																												<div
																													...
																													<hr>
																													<span
																														class="chekc_box_title">旅行業代收轉付電子收據</span><br>
																													<select
																														name=""
																														id="receipt_id"
																														class="form_control1">
																												...
																												<div
																													...
																													<table>
																														...
																														<% for
																															...
																															{
																															if
																															(productBeans.get(i).getProductid()==products.get(k).getProductid())
																															{
																															...
																															<input
																																...
																																name="productid"
																																size="45"
																																value="<%=productBeans.get(i).getProductid()%>" />
																															...
																															<input
																																...
																																name="productprice"
																																size="45"
																																value="<%=productBeans.get(i).getProductprice()%>" />
	...
	<!--Scripts starts-->
										...
										<% TravelerlistBean travelerlistBean=new TravelerlistBean(); java.sql.Date
											birthday=null; try { birthday=travelerlistBean.getBirthday(); } catch
											(Exception e) { birthday=new java.sql.Date(System.currentTimeMillis()); } %>
											...
											<script>
												...
												// 	var productamount = numberoftraveler * <%=productprice%>;
												// 	$(e.target).closest("div.page-wrapper").find("p.total").text(productamount);


												// 	var tmp = $(this).next("div.tmp");
												// 	// tmp.empty();
												// 	for (var i = 0; i < numberoftraveler-1; i++) {
												...
												// 						<select class="same_traveler" idtarget='${i}'>
												// 							<option selected>請選擇</option>
												// 							<option value="same">同訂購人資料</option>
												// 							<option value="213">${i}</option>
												// 						</select>
												// 					</div>

												// 					<div class="form_group">
												// 						<label>出生日期 <span class="require_mark">*</span><br></label> <br>
												// 						<input type="text" name="birthday${i}" class="birthday"
												// 							id="f_date1">
												// 						<div class="tip_text_danger">此欄位必填</div>
												// 					</div>
												// 					<div class="form_group">
												...
												// 						<br> <input type="text" name="idno${i}" class="traveler_id"
												// 							id="traveler_id">
												// 						<div class="tip_text_danger">此欄位必填</div>
												// 					</div>
												// 					<div class="form_group">
												...
												// 							style="margin-left: 10px" type="text" name="lastname${i}"
												// 							class="traveler_last_name" id="traveler_last_name${i}">
												// 						<div class="tip_text_danger">此欄位必填</div>
												// 					</div>
												// 					<div class="form_group">
												// 						<label>名字</label><span class="require_mark">*</span><br> <input
												// 							type="text" name="firstname${i}" class="traveler_first_name"
												// 							id="traveler_first_name">
												// 						<div class="tip_text_danger">此欄位必填</div>
												// 					</div>
												// 			</div>`;
												...
												function calculate() {
													var number = $(".numberoftraveler").val();
													var productamount = number * <%=productprice%>;
													$(".total").text(productamount);
													$(e.target).closest("div.page-wrapper").find(".total").text(productamount);
												}
												...
												//    $(".traveler_infor").find(".traveler_last_name").val(book_last_name);
												// var father1 = $(e).closest("div.traveler_infor");

												// father.find(".traveler_last_name").val(book_last_name);
