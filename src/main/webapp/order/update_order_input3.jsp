										...
										<table>
											...
											<tr>
												...
												<td><input class="input_update" type="TEXT"
													...
													value="<%=orderBean.getMemberid()%>" /></td>
											</tr>

											<tr>
												<td>訂購日期:</td>
												<td><input class="input_update" name="orderdate"
													id="f_date1" type="text"
													value="<%=orderBean.getOrderdate()%>" /></td>
											...
											<tr>
												...
												<td><input class="input_update" type="TEXT"
													...
													value="<%=orderBean.getOrderpriceamount()%>" /></td>
											</tr>
											<tr>
												<td>折抵點數:</td>
												<td><input class="input_update" type="TEXT"
													name="usedfunpoints" size="45"
													value="<%=orderBean.getUsedfunpoints()%>" /></td>
											</tr>
