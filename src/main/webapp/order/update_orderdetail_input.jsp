...
<%
OrderdetailBean orderdetailBean = (OrderdetailBean) session.getAttribute("orderdetailBean"); //EmpServlet.java (Concroller) 存入req的empVO物件 (包括幫忙取出的empVO, 也包括輸入資料錯誤時的empVO物件)
%>
										...
										<table>
											...
											<tr>
												...
												<td><input class="input_update" type="TEXT"
													name="orderid" size="45"
													value="<%=orderdetailBean.getOrderid()%>" /></td>
											</tr>
											<tr>
												<td>商品編號:</td>
												<td><input class="input_update" type="TEXT"
													name="productid" size="45"
													value="<%=orderdetailBean.getProductid()%>" /></td>
											</tr>
											<tr>
												<td>商品名稱:</td>
												<td><input class="input_update" type="TEXT"
													name="productname" size="45" value="" /></td>
											</tr>
											<tr>

												<td>會員姓:</td>
												<td><input class="input_update" type="TEXT"
													name="lastname" size="45" value="" /></td>
											</tr>
											<tr>
												<td>會員名:</td>
												<td><input class="input_update" type="TEXT"
													name="firstname" size="45" value="" /></td>
											</tr>
											<tr>
												<td>旅客人數:</td>
												<td><input class="input_update" type="TEXT"
													name="numberoftraveler" size="45"
													value="<%=orderdetailBean.getNumberoftraveler()%>" /></td>
											</tr>
											<tr>
												<td>商品價格:</td>
												<td><input class="input_update" type="TEXT"
													name="productprice" size="45"
													value="<%=orderdetailBean.getProductprice()%>" /></td>
											</tr>
											<tr>
												<td>回饋點數:</td>
												<td><input class="input_update" type="TEXT"
													name="orderrewardpoints" size="45"
													value="<%=orderdetailBean.getOrderrewardpoints()%>" /></td>
											</tr>
											<tr>
												<td>特殊需求:</td>
												<td><input class="input_update" type="TEXT"
													name="specialneeds" size="45"
													value="<%=orderdetailBean.getSpecialneeds()%>" /></td>
											</tr>
										</table>
										<br> <input type="hidden" name="action" value="update" />
										<input type="hidden" name="orderdetailno"
											value="<%=orderdetailBean.getOrderdetailno()%>" /> <input
