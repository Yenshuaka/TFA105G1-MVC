                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            <div class="db-add-list-wrap">
                                <div class="act-title">
                                    <h5><i class="ion-ios-information"></i> 請輸入商品資訊 :</h5>
                                </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control filter-input" placeholder="" name="productname">
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control filter-input" placeholder="請輸入數字(台幣) 例如:999" name="productprice">
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label>最少成團人數</label>
                                                <input type="text" class="form-control filter-input" placeholder="請輸入數字 例如:4" name="memberrequired">
                                            </div>
                                        </div>
                                        <div class="col-md-12">
                                            <!-- <form> -->
                                                <div class="form-group">
                                                    ...
                                                    <textarea class="form-control" id="list_info" rows="4" placeholder="" name="productintro"></textarea>
                                                </div>
                                            <!-- </form> -->
                                        </div>
                                        ...
                                        <div class="col-md-12">
                                            <!-- <form> -->
                                                <div class="form-group">
                                                    ...
                                                    <textarea class="form-control" id="list_info" rows="4" placeholder="" name="attention"></textarea>
                                                </div>
                                            <!-- </form> -->
                                        </div>
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <label>開始日</label>
                                                    <input type="text" class="form-control filter-input" name="startdate" placeholder="請輸入日期格式: yyyy-MM-dd">
                                                </div>

                                                <div class="col-md-6">
                                                    <label>結束日</label>
                                                    <input type="text" class="form-control filter-input" name="enddate" placeholder="請輸入日期格式: yyyy-MM-dd">
                                                </div>
                                                
                                                <div class="col-md-6">
                                                    <label>旅行時數</label>
                                                    <input type="text" class="form-control filter-input" name="traveltime" placeholder="請輸入小時 例如: 18.5">
                                                </div>
                                                <!-- <div class="col-md-4">
